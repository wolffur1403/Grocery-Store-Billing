...
cb_txt=Label(F1,font='arial 15 bold',width=18,relief=SUNKEN,bd=7,textvariable=cb,justify=CENTER)
...
cw_txt=Label(F1,font='arial 15 bold',width=18,relief=SUNKEN,bd=7,textvariable=cw,justify=CENTER)
...
cr_txt=Label(F1,font='arial 15 bold',width=18,relief=SUNKEN,bd=7,textvariable=cr,justify=CENTER)
...
cg_txt=Label(F1,font='arial 15 bold',width=18,relief=SUNKEN,bd=7,textvariable=cg,justify=CENTER)
...
t_txt=Label(F1,font='arial 15 bold',width=18,relief=SUNKEN,bd=7,textvariable=Total,justify=CENTER)
t_txt.grid(row=5,column=1,padx=20,pady=15)
totalcost_txt=Label(F1,font='arial 15 bold',width=18,relief=SUNKEN,bd=7,textvariable=total_cost,justify=CENTER)
